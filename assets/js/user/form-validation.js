document.addEventListener("DOMContentLoaded", function () {
    ...
    form.addEventListener('input', function () {
        ...
        var allInputsValid = checkRequiredInputs();
        ...
        updateSubmitButtonStyle(submitButton, allInputsValid, areAllCheckboxesChecked);
    });
...
// Fungsi untuk memeriksa keberadaan nilai pada setiap input yang diperlukan
...
// Fungsi untuk memperbarui gaya tombol submit
function updateSubmitButtonStyle(submitButton, allInputsValid, areAllCheckboxesChecked) {
