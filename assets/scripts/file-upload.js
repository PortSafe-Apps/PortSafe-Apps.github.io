...
// Attach event listener for file upload change - Observasi
const fotoObservasiInput = document.getElementById("fotoObservasi");
fotoObservasiInput.addEventListener("change", function (event) {
  prepareUpload(event, document.getElementById("hasilFotoObservasi"), document.getElementById("hasilFotoObservasi"));
});

// Attach event listener for file upload change - Perbaikan
const fotoPerbaikanInput = document.getElementById("fotoPerbaikan");
fotoPerbaikanInput.addEventListener("change", function (event) {
  prepareUpload(event, document.getElementById("hasilFotoPerbaikan"), document.getElementById("hasilFotoPerbaikan"));
});
