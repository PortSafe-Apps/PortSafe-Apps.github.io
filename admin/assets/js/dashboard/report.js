...
// Check if the fetched data is an array before using map
if (Array.isArray(unsafeDataResponse.data) && Array.isArray(compromisedDataResponse.data)) {
            ...
            datasets: [
                {
                    ...
                    pointHitRadius: 10,
                    pointBorderWidth: 2,
                    data: unsafeDataResponse.data.map(item => item.value)
                },
                {
                    label: "Compromised",
                    yAxisID: "y-axis-1",
                    ...
                    pointHitRadius: 10,
                    pointBorderWidth: 2,
                    data: compromisedDataResponse.data.map(item => item.value)
                }
            ]
        },
        options: {
